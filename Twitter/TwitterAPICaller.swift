...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "LJeg2o0lUO5pt9AcfSXuPjRJ6", consumerSecret: "SFeZDQGUHCvyHDtiH0iBs3HG5ucoJ04TuwnPkVmZCeFBHsMkSV")
    var loginSuccess: (() -> ())?
